...
module.exports = require('./webpack.base.babel')({
  ...
  cssLoaders: ExtractTextPlugin.extract({
    ...
    use: [
      {
        loader: 'css-loader',
        options: { autoprefixer: false, modules: true, importLoaders: 1 },
      },
      {
  ...
  externalCssLoaders: ExtractTextPlugin.extract({
    fallback: 'style-loader',
    use: ['css-loader'],
  }),
  ...
  sassLoaders: ExtractTextPlugin.extract({
    ...
    use: [
      {
        loader: 'css-loader',
        options: { autoprefixer: false, modules: true, importLoaders: 2 },
      },
      {
        loader: 'postcss-loader',
        options: {
